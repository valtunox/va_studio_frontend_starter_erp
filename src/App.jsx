/**
 * VA Studio Frontend — ERP Standalone
 *
 * This is a standalone version of the ERP template.
 * It renders the ERP template directly as the main interface.
 *
 * Routes:
 *   /  → ERP template (default)
 *
...
import TemplateApp from '../templates/erp/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (ERP Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
